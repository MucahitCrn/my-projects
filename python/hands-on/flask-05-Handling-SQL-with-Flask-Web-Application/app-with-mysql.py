...
app.config['MYSQL_DATABASE_HOST'] = 'PASTE HERE RDS ENDPOINT LINK'
app.config['MYSQL_DATABASE_USER'] = 'USERNAME'
app.config['MYSQL_DATABASE_PASSWORD'] = 'WRITE A PASSWORD'
app.config['MYSQL_DATABASE_DB'] = 'DATABASE DB NAME'
